...
class DreamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dream" do
    assert_difference('Dream.count') do
      post dreams_url, params: { dream: { description: @dream.description, title: @dream.title } }, as: :json
    end
  ...
  test "should update dream" do
    patch dream_url(@dream), params: { dream: { description: @dream.description, title: @dream.title } }, as: :json
    assert_response 200
  end
